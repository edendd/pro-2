const searchDistance = document.querySelector(`#search-by-hourly rate`);
const searchPrice = document.querySelector(`#search-by- area `);
const searchRating = document.querySelector(`#search-by-occ title`);

const occupationReturned = document.querySelector(`#occupation-returned`);
const occupationInfoModal = document.querySelector("#modal-occupation-info");
